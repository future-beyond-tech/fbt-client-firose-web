    ...
    <section className={styles.transitionBanner}>
      ...
      <div className={styles.ownershipFooter}>
        ...
        <p className={styles.ownershipText}>
          <strong>Division Relationship:</strong> Femison is presented as an operating division of{' '}
          <Link href="/" className={styles.ownershipLink}>
            Firose Enterprises
          </Link>
          . Visit the dedicated Femison website for current brand-specific information.
        </p>
      </div>
    </section>
  );
