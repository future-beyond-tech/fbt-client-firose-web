...
export const metadata: Metadata = {
  title: 'Home',
  description:
    'Firose Enterprises is a diversified enterprise group across fragrance, baby care and nutrition, hygiene FMCG, and AI-driven technology systems.',
};
        ...
        <MotionWrapper delay={0.22}>
          ...
          <div className="mt-4 grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              'Baby Care, Arwat & Glucose Nutrition',
